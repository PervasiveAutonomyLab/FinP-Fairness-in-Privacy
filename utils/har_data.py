...
def process_har_data(combine_train_test: bool = False,balance_dataset: bool = False, num_subjects: int = 30,random_activity_sample = False):
    set_seed(30)  # Set seed at the start of the function for reproducibility
