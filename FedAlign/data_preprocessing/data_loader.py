...
def load_partition_data(data_dir, partition_method, alpha, num_users, batch_size):
    class_num, net_dataidx_map, traindata_cls_counts = partition_data(data_dir, partition_method, num_users, alpha)

    logging.info("traindata_cls_counts = " + str(traindata_cls_counts))
    train_data_num = sum([len(net_dataidx_map[r]) for r in range(num_users)])
