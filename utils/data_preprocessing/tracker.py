...
class Tracker:
    def __init__(self, args,class_num):
        ...
        self.client_accuracy = {i: [-1] * self.args.epochs for i in range(self.args.client_number)}
        self.sia_accuracy =  {i: [-1] * self.args.epochs for i in range(self.args.client_number)}
    ...
    def add_model_accuracy(self, iteration, accuracy):
    ...
    def save_results(self, folder, filename='saved_results_1.pkl'):
        ...
        with open(file_path, 'wb+') as f:
            pickle.dump([self.sia_accuracy, self.client_accuracy, {}, self.model_accuracy_train, self.model_accuracy_test, self.class_accuracy, self.sia_accuracy_avg], f)
